...
namespace Setup.BL.Lead
{
    public class Notes : INotes
    {
        ...
        public Notes(IDistributedCache cache, IHostEnvironment hostEnvironment, IAppVariables appVariables, IHttpContextAccessor httpContextAccessor, IConfiguration con)
        {
        ...
        #region Get Lead or customer Notes Method
        public ResponseClass<NotesResponse> GetNotesByID(NotesDTO ObjRequest)
        {
            ResponseClass<NotesResponse> response = new ResponseClass<NotesResponse>();
            ...
            {
                #region Parameters
                objSpParameters.Add("SPLeadID", DbType.Int32, ObjRequest.LeadID, ParameterDirection.Input);
                objSpParameters.Add("SPCustomerID", DbType.Int32, ObjRequest.CustomerID , ParameterDirection.Input);
                ...
                objCommandExecutor.ExecuteDataSet(CommandType.StoredProcedure, "notes_table", dsLogin, TableName, objSpParameters);
        ...
        #region Get Lead Notes Method
        public ResponseClass<DocsResponse> GetDocsByID(DocsDTO ObjRequest)
        {
            ResponseClass<DocsResponse> response = new ResponseClass<DocsResponse>();
            ...
            try
            {
                ...
                string _Json = string.Empty;
                string[] TableName = { "Response Table", "Data" };
                objCommandExecutor.ExecuteDataSet(CommandType.StoredProcedure, "docs_table_reporting", dsLogin, TableName, objSpParameters);
