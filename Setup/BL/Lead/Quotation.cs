...
namespace Setup.BL.Lead
{
    public class Quotation : IQuotation
    {
        ...
        public Quotation(IDistributedCache cache, IHostEnvironment hostEnvironment, IAppVariables appVariables, IHttpContextAccessor httpContextAccessor, IConfiguration con)
        {
        ...
        public ResponseClass<QuotationResponse> GetAllQuotationData(QuotationDTO ObjRequest)
        {
            ResponseClass<QuotationResponse> response = new ResponseClass<QuotationResponse>();
            ...
            try
            {
                ...
                objCommandExecutor.ExecuteDataSet(CommandType.StoredProcedure, "quotation_master", dsLogin, TableName, objSpParameters);
