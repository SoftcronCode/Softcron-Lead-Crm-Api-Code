...
namespace Setup.BL.UserManagment
{
    public class UserManagment : IUserManagment
    {
        ...
        public UserManagment(IDistributedCache cache, IHostEnvironment hostEnvironment, IAppVariables appVariables, IHttpContextAccessor httpContextAccessor, IConfiguration con)
        {
        ...
        public ResponseClass<UserManagmentResponse> ManageUser(UserManagmentDTO ObjRequest)
        {
            ResponseClass<UserManagmentResponse> response = new ResponseClass<UserManagmentResponse>();
            ...
            try
            {
                ...
                objSpParameters.Add("SPGroupMasterId", DbType.String, ObjRequest.groupmasterid, ParameterDirection.Input);
                objSpParameters.Add("SPUserId", DbType.String, ObjRequest.userid, ParameterDirection.Input);
                ...
                objCommandExecutor.ExecuteDataSet(CommandType.StoredProcedure, "user_managment_operation", dsLogin, TableName, objSpParameters);
