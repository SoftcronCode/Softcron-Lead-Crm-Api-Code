...
{
    public class PaymentReport : IPaymentReport
    {
        #region Common Data
        ...
        public PaymentReport(IDistributedCache cache, IHostEnvironment hostEnvironment, IAppVariables appVariables, IHttpContextAccessor httpContextAccessor, IConfiguration con)
        {
        ...
        #region Payment Reporting Method
        public ResponseClass<PaymentReportResponse> PaymentReporting(PaymentReportDTO ObjRequest)
        {
            ResponseClass<PaymentReportResponse> response = new ResponseClass<PaymentReportResponse>();
            ...
            try
            {
                ...
                objCommandExecutor.ExecuteDataSet(CommandType.StoredProcedure, "payment_reporting", dsLogin, TableName, objSpParameters);
