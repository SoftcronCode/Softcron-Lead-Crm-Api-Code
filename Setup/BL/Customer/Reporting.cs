...
namespace Setup.BL.Customer
{
    public class Reporting : IReporting
    {
        ...
        public Reporting(IDistributedCache cache, IHostEnvironment hostEnvironment, IAppVariables appVariables, IHttpContextAccessor httpContextAccessor, IConfiguration con)
        {
        ...
        #region Customer Reporting Method
        public ResponseClass<ReportingResponse> CustomerReporting(ReporingDTO ObjRequest)
        {
            ResponseClass<ReportingResponse> response = new ResponseClass<ReportingResponse>();
            ...
            try
            {
                ...
                objCommandExecutor.ExecuteDataSet(CommandType.StoredProcedure, "customer_table_reporting", dsLogin, TableName, objSpParameters);
        ...
        #region Customer Sales Record Method
        public ResponseClass<SalesRecordResponse> CustomerSalesRecord(SalesRecordDTO ObjRequest)
        {
            ResponseClass<SalesRecordResponse> response = new ResponseClass<SalesRecordResponse>();
            ...
            {
                #region Parameters
                objSpParameters.Add("SPCustomerID", DbType.Int32, ObjRequest.Customer_id, ParameterDirection.Input);
                //objSpParameters.Add("SPInsertUserID", DbType.String, ObjRequest.ObjCommon.InsertedUserID, ParameterDirection.Input);
                //objSpParameters.Add("SPInsertIPAddress", DbType.String, ObjRequest.ObjCommon.InsertedIPAddress, ParameterDirection.Input);
                #endregion
                ...
                string _Json = string.Empty;
                string[] TableName = { "Response Table", "Data" };
                objCommandExecutor.ExecuteDataSet(CommandType.StoredProcedure, "customer_sales_record", dsLogin, TableName, objSpParameters);
