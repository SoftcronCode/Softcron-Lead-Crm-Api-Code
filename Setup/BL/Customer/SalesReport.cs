...
namespace Setup.BL.Customer
{
    public class SalesReport : ISalesReport
    {
        ...
        public SalesReport(IDistributedCache cache, IHostEnvironment hostEnvironment, IAppVariables appVariables, IHttpContextAccessor httpContextAccessor, IConfiguration con)
        {
        ...
        public ResponseClass<SalesReportResponse> SalesReporting(SalesReportDTO ObjRequest)
        {
            ResponseClass<SalesReportResponse> response = new ResponseClass<SalesReportResponse>();
            ...
            try
            {
                ...
                objCommandExecutor.ExecuteDataSet(CommandType.StoredProcedure, "sales_reporting", dsLogin, TableName, objSpParameters);
